...
import { SupabaseAnimalRepository } from '../../infrastructure/repositories/supabase/SupabaseAnimalRepository';
import { CrearAnimalUseCase } from '../../core/use-cases/animales/crearAnimal.use-case';
import { ObtenerAnimalesUseCase } from '../../core/use-cases/animales/obtenerAnimales.use-case';
import { EliminarAnimalUseCase } from '../../core/use-cases/animales/eliminarAnimal.use-case';
...
export function useAnimales() {
  ...
  }, [obtenerAnimalesUseCase]);

  const crearAnimal = useCallback(async (animalData: {
    nombre: string;
    numeroArete: string;
  ...
  }, [cargarAnimales, crearAnimalUseCase]);
  ...
  }, [cargarAnimales, eliminarAnimalUseCase]);
